...
GUIDANCE='--clf_guidance True --pretrained_dir /export/livia/home/vision/Ymohammadi/Dataset/ffhq/'

# TRAIN
LOG_DIR='--log_dir /export/livia/home/vision/Ymohammadi/Code/results_sketch_guide/logs'
DATA_DIR='--data_dir /export/livia/home/vision/Ymohammadi/Dataset/sketch10/'
CHKPT_DIR='--checkpoint_dir /export/livia/home/vision/Ymohammadi/Code/results_sketch_guide/checkpoints/'
SAVE_SAMPLES_DIR='--save_samples_dir /export/livia/home/vision/Ymohammadi/Code/results_sketch_guide/samples/'
MODEL_PATH='--model_path /export/livia/home/vision/Ymohammadi/Code/ffhq_baseline.pt'
TRAIN_FLAGS='--sampling True --how_many_samples 10' #5154'
python /export/livia/home/vision/Ymohammadi/Code/P2-weighting/scripts/image_train.py $FFHQ_FLGAS $FFHQ_TRAIN_FLAGS $DDIM $TRAIN_FLAGS $MODEL_PATH $LOG_DIR $DATA_DIR $CHKPT_DIR $SAVE_SAMPLES_DIR $GUIDANCE 
